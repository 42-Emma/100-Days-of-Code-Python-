...
if decision1 == "left":
    decision2 = input("You've come to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for "
                      "a boat. Type \"swim\" to swim across.\n").lower()
    if decision2 == "wait":
        decision3 = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow, "
